...
begin
  ...
  if v_id_vuelo = 1 then 
    ...
    dbms_output.put_line('Prueba fallida, id_vuelo incorrecto');
  end if;
exception
  when 20004 then
    dbms_output.put_line('Prueba fallida, no debería lanzar excepción');
end;
/
show errors;
